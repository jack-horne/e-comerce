    ...
    <nav>
        <ul class="list-unstyled">
            ...
            <li class="mt-5 border-top pt-3">
                <a href="/e_commerce2/backend/auth.php?action=logout" class="text-danger text-decoration-none d-block p-2 rounded hover-menu" onclick="return confirm('Yakin ingin keluar?')">
